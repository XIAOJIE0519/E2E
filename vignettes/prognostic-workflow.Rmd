...
figure_pro(type = "km", data = stacking_lasso_pro_results, time_unit= "days", output_file = "Prognostic_KM",
           output_type = "pdf")

# Time-Dependent ROC Curve
figure_pro(type = "tdroc", data = stacking_lasso_pro_results, time_unit = "days", output_file = "Prognostic_TDROC", output_type = "pdf")
```
